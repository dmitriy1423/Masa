...
var _menu = require("./modules/menu/menu");
...
var _filter = _interopRequireDefault(require("./modules/filter/filter"));
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    var burger = new _menu.Burger();
    burger.init();
    var select = new _customSelect.CustomSelect();
    select.init();
  });
  document.querySelector('.about__button').addEventListener('click', function () {
...
},{"./modules/accordion/accordion":2,"./modules/filter/filter":4,"./modules/form-validate/form":6,"./modules/map/map":12,"./modules/menu/menu":13,"./modules/modals/init-modals":14,"./modules/select/custom-select":17,"./modules/sliders/sliders":19,"./utils/ios-vh-fix":22}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initAccordion = exports.accordions = void 0;
...
},{"./accordions":3}],3:[function(require,module,exports){
"use strict";
...
function initFilter() {
  var filterList = document.querySelector('.news__filter');
  var options = document.querySelectorAll('.news__filter-option');
...
function initMap() {
  ...
  if (mapContainer) {
    ...
    var marker = new _leaflet.default.Marker([55.028522, 82.928281], markerOptions);
    marker.addTo(map);
  }
}
...
},{"../../vendor/leaflet":24}],13:[function(require,module,exports){
"use strict";
...
var Burger = /*#__PURE__*/function () {
  ...
  _createClass(Burger, [{
    ...
    key: "_onBurgerClick",
    value: function _onBurgerClick(evt) {
...
function initSliders() {
  ...
  var newsSlides = Array.from(document.querySelectorAll('.news-card'));
  ...
  function mobileSizeNewsSlides() {
    if (mobileWidth.matches && news.dataset.mobile === 'false') {
      var firstSlideBelowIndex = Math.ceil(newsSlides.length / 2);
      for (var i = 0; i < firstSlideBelowIndex; i++) {
        newsSlides[i].style.height = '330px';
      }
      for (var _i = firstSlideBelowIndex; _i < newsSlides.length; _i++) {
        newsSlides[_i].style.height = '240px';
      }
      news.dataset.mobile = 'true';
    }
    if (!mobileWidth.matches) {
      news.dataset.mobile = 'false';
      for (var _i2 = 0; _i2 < newsSlides.length; _i2++) {
        newsSlides[_i2].style.height = 'auto';
      }
    }
  }
